...
public class UIItemCard : MonoBehaviour
{
	...
	GameObject AddGameObject (string spriteName, int number)
	{
		...
		UISprite sp = tempObj.GetComponentInChildren<UISprite> ();			
				...
				for (int x = 0; x < columns; x++) {
					...
					if (PlayerPrefs.GetInt (tmp) > 0) {
						...
						case 1:
							...
							objGo = AddGameObject (atlasSpriteNames [2], _number + 1);
							break;
						case 2:
							//objGo = Other ("level1-2", template, _number + 1);
							objGo = AddGameObject (atlasSpriteNames [3], _number + 1);
							break;
						case 3:
							//objGo = Other ("level1-3", template, _number + 1);
							objGo = AddGameObject (atlasSpriteNames [4], _number + 1);
							break;
						/*default:
							objGo = Other ("level0", template, _number + 1);
							break;*/
